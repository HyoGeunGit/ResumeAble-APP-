    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btgo.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent=new Intent(BlueToothActivity.this,BleGetter.class);
...
//        }
    ...
    protected void onDestroy() {
        ...
        LocalBroadcastManager.getInstance(this).unregisterReceiver(mBluetoothSearchReceiver);
        LocalBroadcastManager.getInstance(this).unregisterReceiver(mBluetoothScanmodeReceiver);
        super.onDestroy();
    }
}
